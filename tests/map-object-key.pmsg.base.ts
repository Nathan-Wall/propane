...
export class MapObjectKey extends Message<MapObjectKey.Data> {
  ...
  $fromEntries(entries: Record<string, unknown>, options?: {
    ...
    if (!((ImmutableMap.isInstance(objectKeysMapValueConverted) || objectKeysMapValueConverted as object instanceof Map) && [...(objectKeysMapValueConverted as ReadonlyMap<unknown, unknown>).entries()].every(([mapKey, mapValue]) => typeof mapValue === "string"))) throw new Error("Invalid value for property \"objectKeys\".");
    ...
    if (optionalObjectMapMapValueConverted !== undefined && !(ImmutableMap.isInstance(optionalObjectMapMapValueConverted) || optionalObjectMapMapValueConverted as object instanceof Map)) throw new Error("Invalid value for property \"optionalObjectMap\".");
