...
export class MapArrayKey extends Message<MapArrayKey.Data> {
  ...
  $fromEntries(entries: Record<string, unknown>, options?: {
    ...
    if (!((ImmutableMap.isInstance(arrayValuesMapValue) || arrayValuesMapValue as object instanceof Map) && [...(arrayValuesMapValue as ReadonlyMap<unknown, unknown>).entries()].every(([mapKey, mapValue]) => (ImmutableArray.isInstance(mapKey) || Array.isArray(mapKey)) && [...(mapKey as Iterable<unknown>)].every(element => typeof element === "string") && typeof mapValue === "number"))) throw new Error("Invalid value for property \"arrayValues\".");
    ...
    if (!((ImmutableMap.isInstance(numberArrayMapMapValue) || numberArrayMapMapValue as object instanceof Map) && [...(numberArrayMapMapValue as ReadonlyMap<unknown, unknown>).entries()].every(([mapKey, mapValue]) => (ImmutableArray.isInstance(mapKey) || Array.isArray(mapKey)) && [...(mapKey as Iterable<unknown>)].every(element => typeof element === "number") && typeof mapValue === "string"))) throw new Error("Invalid value for property \"numberArrayMap\".");
    ...
    if (optionalArrayMapMapValueConverted !== undefined && !((ImmutableMap.isInstance(optionalArrayMapMapValueConverted) || optionalArrayMapMapValueConverted as object instanceof Map) && [...(optionalArrayMapMapValueConverted as ReadonlyMap<unknown, unknown>).entries()].every(([mapKey, mapValue]) => (ImmutableArray.isInstance(mapKey) || Array.isArray(mapKey)) && [...(mapKey as Iterable<unknown>)].every(element => typeof element === "boolean")))) throw new Error("Invalid value for property \"optionalArrayMap\".");
    ...
    switch (key) {
      case "arrayValues":
        return new (this.constructor as typeof MapArrayKey)({
          arrayValues: child as Map<string[], number> | Iterable<[string[], number]>,
      ...
      case "numberArrayMap":
        return new (this.constructor as typeof MapArrayKey)({
          ...
          numberArrayMap: child as Map<number[], string> | Iterable<[number[], string]>,
          optionalArrayMap: this.#optionalArrayMap as Map<boolean[], Date> | Iterable<[boolean[], Date]>
        }) as this;
      case "optionalArrayMap":
        return new (this.constructor as typeof MapArrayKey)({
          arrayValues: this.#arrayValues as Map<string[], number> | Iterable<[string[], number]>,
          numberArrayMap: this.#numberArrayMap as Map<number[], string> | Iterable<[number[], string]>,
          optionalArrayMap: child as Map<boolean[], Date> | Iterable<[boolean[], Date]>
        }) as this;
      default:
