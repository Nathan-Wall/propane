...
export class ArrayMessage extends Message<ArrayMessage.Data> {
  ...
  $fromEntries(entries: Record<string, unknown>, options?: {
    ...
    if (!(labelsArrayValue as object instanceof ImmutableArray || Array.isArray(labelsArrayValue))) throw new Error("Invalid value for property \"labels\".");
    props.labels = labelsArrayValue as ArrayMessage_Labels_Item[] | Iterable<ArrayMessage_Labels_Item>;
